...
no longer the principal gap. Physical occupation remains unresolved: an
inequivalent energy-sharing ownership completion has the same current narrow
source reduct, so transport or recovery success cannot select the primary
...
Hessian positivity alone. Their Nature-level occupation remains physical
